...
class MeController {
    ...
    storedUser(req, res, next) {
        ...
        // User.find({})
        //     .then(user => res.render('me/userAll', {
        //         user: mutipleMongooseToObject(user),
        //     }))
        //     .catch(next);
    ...
    // [GET] /me/stored/user/:id/edit
    editUser(req, res, next) {
        User.findById(req.params.id)
            .then(user => res.render('me/editUser', {
    ...
    // [DELETE] /me/user/:id/force
    forceDestroyUser(req, res, next) {
